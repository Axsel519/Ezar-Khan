        ...
        <div className="payment-methods">
          ...
          <div className="payment-option">
            ...
            <label htmlFor="instapay" className="payment-label">
              ...
              <div className="payment-info">
                <h6>انستا باي</h6>
                <p className="text-muted">تحويل بنكي فوري</p>
              </div>
            </label>
          </div>
          ...
          <div className="payment-option">
            <input
              ...
              name="paymentMethod"
              value="vodafone-cash"
              checked={formData.paymentMethod === "vodafone-cash"}
              onChange={handleInputChange}
              className="payment-radio"
            />
            <label htmlFor="vodafone-cash" className="payment-label">
              <div className="payment-icon vodafone-icon">
                <i className="bi bi-phone"></i>
              </div>
              <div className="payment-info">
                <h6>فودافون كاش</h6>
                <p className="text-muted">الدفع عبر المحفظة الإلكترونية</p>
              </div>
            </label>
          </div>
        </div>
